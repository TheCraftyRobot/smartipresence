...
<body>
  ...
  <div class="aw-sec4_1" id="form-section">
    <div class="text-center">
      <p class="aw-title1">Please Enter an Access Key!</p>
      <div class="clearfix"></div><br/>
      <div class="container">
        <img src="./crafty_robot.png">
        <div class="clearfix"></div><br/>
    ...
    if (navigator.share) {
      ...
      if(search_paramsB.has('accessKey')) {
         ...
         navigator.share({
           ...
           text: 'Now that your bots connecting - you can share its unique driving page with your friends!',
           url: shareURL,
         })
